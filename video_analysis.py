...
def ana_video(location):
    helmet_violation_count = 0
    triple_violation_count = 0
    ...
    with open('violation_report.csv', 'w', newline='') as file:
            ...
            writer.writerow([location, "Helmet Violation", helmet_violation_count,"Triple Violation", triple_violation_count])
